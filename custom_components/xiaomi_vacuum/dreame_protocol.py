...
class DreameProtocol:
    def __init__(
        ...
        # token può essere str (hex) o bytes (già convertito)
    ...
    def send_handshake(self) -> Message:
        ...
        m = DreameProtocol.discover(self.ip)
        if m is not None:
